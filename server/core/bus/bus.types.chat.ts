...
export interface ChatEvents {
  ...
  "chat.turn.delete":         { req: { chatId: string; turnId: string }; res: { deleted: number } };
  "chat.entry.edit":          { req: { chatId: string; rowid: number; content: string }; res: { ok: boolean } };
  ...
  "chat.ask":                 { req: { chatId: string; content: string; attachmentIds?: string[]; services?: string[]; skills?: string[]; mode?: "read" | "write" | "execute"; knowledgeFilters?: string[]; await?: boolean }; res: { ok: boolean } };
  ...
  "chat.system.ask":          { req: { content: string; kind?: "general" | "connection" | "permissions" | "skills" | "routines"; mode?: "read" | "write" | "execute" }; res: { chatId: string } };
