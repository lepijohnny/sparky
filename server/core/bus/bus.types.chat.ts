...
export interface ChatEvents {
  ...
  "chat.ask":                 { req: { chatId: string; content: string; attachmentIds?: string[]; services?: string[]; skills?: string[]; mode?: "read" | "write" | "execute"; knowledgeFilters?: string[] }; res: { ok: boolean } };
