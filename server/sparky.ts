...
export function createSparky(): Sparky {
  ...
  const auth = createAuthManager(authLog, cred, oauthGateway, buildAuthFlows(logger, adapters.getById("copilot")));
  ...
  function buildAuthFlows(lg: FileLogger, copilot: ProviderAdapter | undefined): AuthFlow[] {
