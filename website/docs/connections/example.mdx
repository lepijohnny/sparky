---
sidebar_position: 3
description: "Step-by-step example of setting up an LLM provider connection in Sparky."
...
<video src={require('../assets/uc/brave-connect.mp4').default} autoPlay muted loop playsInline style={{maxWidth: '700px', width: '100%'}} />
