...
Skills can be imported from [ClawHub](https://clawhub.com), a community skill registry. The skills agent handles downloads and extraction.

Imported skills go through a review process before activation — see [Review & Activation](#review--activation) below.
