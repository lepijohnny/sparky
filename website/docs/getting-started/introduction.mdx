---
sidebar_position: 1
description: "Introduction to Sparky — a modern desktop AI assistant with multi-provider LLM support, RAG knowledge base, and extensible skills."
...
- **Multi-provider agents** — Use Claude, GitHub Copilot, Google Gemini, Mistral or run models locally with Ollama. Switch providers per chat.
