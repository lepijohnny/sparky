---
sidebar_position: 1
description: "RAG knowledge base — add documents, index locally, and get AI answers grounded in your data."
sidebar_label: RAG
---
...
Text files, Markdown, PDF, HTML, and URLs are supported out of the box.
